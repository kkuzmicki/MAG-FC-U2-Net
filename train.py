...
def train(args, model, device, train_loader, optimizer, scaler):
    ...
    for x, y in tqdm.tqdm(train_loader):
        ...
        with torch.cuda.amp.autocast():
            ...
            PSNR_error = 300 / utils.PSNR(1000, MSE)
...
def get_parser():
    ...
    parser.add_argument('--model', type=str, default="models/musdb16_model_loss_weight300_max1000") # name for model (may already exist)
